...
function WaveformBg({ peaks, accentColor, baseColor }) {
  ...
  return (
    <canvas ref={canvasRef} width={600} height={44}
      style={{ position:'absolute', top:0, left:0, width:'100%', height:'100%', pointerEvents:'none', borderRadius:4 }} />
  )
}
