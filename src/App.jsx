...
export const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .player-bar { position: fixed; bottom: 0; left: 0; right: 0; background: #11131a; border-top: 1px solid #2a2e42; padding: 12px 24px; z-index: 200; display: flex; align-items: center; gap: 20px; }
  ...
  .player-track-sub { font-size: 11px; color: #4a4e65; }
