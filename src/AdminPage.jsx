                ...
                >
                  ...
                  {!search && !isEditing && (
                    <div
                      ...
                      onDragOver={e => e.preventDefault()}
                      style={{display:'flex', alignItems:'center', justifyContent:'center', width:20, flexShrink:0, cursor:'grab', color:T.textMuted, fontSize:14, opacity:0.35, userSelect:'none', marginRight:4}}
